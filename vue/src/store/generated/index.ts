...
import JwtraderaLoanJwtraderaLoanLoan from './jwtradera/loan/jwtradera.loan.loan'
...
export default { 
  ...
  JwtraderaLoanJwtraderaLoanLoan: load(JwtraderaLoanJwtraderaLoanLoan, 'jwtradera.loan.loan'),
